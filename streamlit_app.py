...
st.title("Wordle Game Clues") # this is the title of the app
...
with a:
    first_letter = st.text_input(label="1st letter",value = 'a')
with b:
    second_letter = st.text_input(label="2nd letter", value = 'b')
with c:
    third_letter = st.text_input(label="3rd letter", value = 'e')
with d:
    fourth_letter = st.text_input(label="4th letter", value = '')
with e:
    fifth_letter = st.text_input(label="5th letter", value = 't')

# combine all the letters 

clue = first_letter+second_letter+third_letter+fourth_letter+fifth_letter

st.markdown("### Wordle Letters")
...
exclusions = st.text_input(label="Write letters you want to exclude (without spaces)")
